...
This repo now includes a multi-page web app that implements the hackathon ideas using the provided datasets.

### Run Locally

```bash
cd edition_1_valentines
python -m venv .venv
...
### What It Includes
- Love Letter Generator (template-based)
- Smart Chocolate Recommender
- Compatibility Copilot
- Valentine's Sales Dashboard
- Global Love Tracker
- Gift Concierge Bot
- Supply Chain Optimizer
- Valentine's Order App
- Love Analytics Platform
